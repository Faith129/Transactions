...
public class CommonMethods {
	...
	public static <T> T xmlStringToObject(String xmlString, Class<T> clazz) {
		...
		JAXBElement<T> jxb = null;
		try {
			JAXBContext jc = JAXBContext.newInstance(clazz);
			Unmarshaller unmarshaller = jc.createUnmarshaller();
			StreamSource streamSource = new StreamSource(new StringReader(xmlString));
			jxb = unmarshaller.unmarshal(streamSource, clazz);
	...
	public static <T> T JSONStringToObject(String jsonStr, Class<T> clazz) {
		Gson gson = new Gson();
		T JavaObject = gson.fromJson(jsonStr, clazz);
		return JavaObject;
	}
...
//	}
	...
	public static <T> T JSONOrXMLToObject(String message, Class<T> clazz) {
	...
	public static String ObjectToJSONOrXMLstring(String request, Object response) {
	...
	public static String escapeSpecialCharacter(String StringToEscape){
		return StringEscapeUtils.escapeHtml4(StringToEscape);
	}
	
	public static boolean isSpecialCharacter(String StringToEscape){
		return Pattern.compile("[^a-zA-Z0-9]").matcher(StringToEscape).find();
	}
	...
	public static String random12Number() {
		Random random =  new Random();
		String seed1 = random.nextInt(999999999) + 100000000 + "";
		String seed2 = random.nextInt(999) + 100 + "";
		return seed1+seed2;
	}
	
	public static String random6Number() {
		Random random =  new Random();
		String seed1 = random.nextInt(999999) + 100000 + "";
		return seed1;
	}
...
//				"neptune", "ORACLE");
		...
		String startDate = CommonMethods.getCurrentDateAsString("yyMMddHHmmss");
		...
		String endDate = CommonMethods.addMonth(startDate, "yyMMddHHmmss", 1) + "";
...
//		System.out.println(randomNumber(1000000000, 999999999));
//		System.out.println(random12Number());
		String test = "�tienne Ga�l Oc�ane Aim�e";
		String test2 = "This is FROM NIBSS | Plc !@#$%^&*(GROUP)_-+={[LIMITED]}|Outward, to this account/><�";
		System.out.println(escapeSpecialCharacter(test2));
		System.out.println(escapeSpecialCharacter(test));
		System.out.println(isSpecialCharacter(test));
